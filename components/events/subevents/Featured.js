...
const Featured = ({ color, bg, smcolor }) => {
    return (
        <div style={bg ? { backgroundColor: bg } : ''} className='w-full md:w-[95%] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 align-middle justify-center m-auto border-[5px] border-[#F7F7F7] mt-20 py-10' >
