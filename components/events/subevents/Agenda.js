...
const Agenda = ({ bordercolor }) => {
    return (
        <div style={{ borderColor: bordercolor }} className='mt-10 border-[5px] border-[#F7F7F7] md:pr-[0px!important] p-3 md:p-10 grid grid-cols-5'>
            ...
            <div style={{ borderColor: bordercolor }} className='border-b-[5px] border-[#F7F7F7] col-span-4 p-10  font-bold text-base'>
                Registrations
            </div>
            <div style={{ borderColor: bordercolor }} className='border-r-[5px] border-[#F7F7F7] p-10 opacity-70'>
            ...
            <div style={{ borderColor: bordercolor }} className=' border-b-[5px] border-[#F7F7F7] col-span-4 p-10 flex flex-col gap-4 '>
