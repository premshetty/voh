...
const KeyTrackCard = ({ bg }) => {
    return <div style={{ backgroundColor: bg }} className='flex flex-col items-center w-[300px] h-[530px]'>
        ...
        <div className='p-3 mt-2 flex flex-col w-full gap-6 justify-center items-center'>
            <p className='text-white text-2xl font-bold items-center justify-center font-sans'> EXHIBITION</p>
            <div className='h-[5px] bg-[#FFFFFF] opacity-30 w-[60%] mx-auto'></div>
            <p className='text-white opacity-80 font-proxima'>
...
const GuestCard = () => {
    return <div className={`${classes.IdeaLeaderCard} flex flex-col w-[330px] h-[480px] bg-white border-[5px] border-[#F7F7F7]`}>
        <img src="/persons/guest.jpg" className='h-[200px] w-full object-cover' alt="" />
        <div className='flex flex-col w-full p-3 gap-6'>
            <p className='text-2xl text-[#AD565B] font-bold font-sans'>GUEST OF HONOUR</p>
            <p className='text-lg font-bold font-proxima'>Sri Dr. Jatindera Singh</p>
            <p className=' opacity-80 text-base font-proxima'>
        ...
        <div>
            ...
            <div className='mt-20 flex relative'>
                ...
                <div className='h-12 top-[-20px] absolute w-[50%] bg-[#AD565B] px-10 py-2 '>
                    <p className='text-white text-2xl font-[500] font-sans'>Overview</p>
                </div>
            </div>
            <div className='mt-20 grid grid-cols-1 gap-8 md:grid-cols-2'>
                ...
                <div className=''>
                    ...
                    <div className='opacity-80 flex flex-col font-proxima gap-6 mt-8'>
            ...
            <div className='mt-20 flex relative'>
                ...
                <div className='h-12 top-[-20px] absolute w-[50%] bg-[#AD565B] px-10 py-2 '>
                    <p className='text-white text-2xl font-[500] font-sans'>Key Tracks</p>
                </div>
            </div>
            <div className='flex mt-20 justify-center items-center flex-col md:flex-row'>
            ...
            <div className='grid grid-cols-1 gap-y-10 md:grid-cols-4 mt-16'>
                <GuestCard />
                <GuestCard />
                <GuestCard />
                <GuestCard />
            ...
            <div className='bg-[#F0F0F0] md:p-10 p-3 -ml-10  w-[98.5vw]  mt-20'>
