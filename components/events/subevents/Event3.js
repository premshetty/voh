...
const Card = () => {
    return <div className={`w-[300px]  flex flex-col ${classes.IdeaLeaderCard} justify-center p-16 gap-10 h-[300px] bg-[#05B4A2] origin-top-left cursor-pointer`}>
        <img src="/icons/globe.svg" className='h-16 ' alt="" />
        <p className='text-white  text-2xl font-[500] -ml-4'>Healthcare for New India @75</p>
    </div>
}
const GuestCard = () => {
    return <div className={`${classes.IdeaLeaderCard} flex flex-col w-[330px] h-[450px] bg-[#65D1C6]`}>
...
const Event3 = () => {
    return (
        <div>
            ...
            <div className='text-base mt-10 flex flex-col gap-8 justify-center items-start w-[80%] opacity-80 mx-auto'>
