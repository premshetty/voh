...
const Card = ({ img }) => {
    return (
        <div className={` relative h-[250px] p-3 min-w-[350px] border-b-[1px] border-[#00000049]`}>
            <div className='flex gap-4'>
                <img className='h-[100px] w-auto' src={img} alt="" />
            ...
            <div className='px-5 flex flex-col gap-4 mt-3'>
                ...
                <button className='h-10 w-32 bg-button_cta font-bold absolute bottom-2 right-2 text-white'>Read more</button>
            </div>
        </div>
    )
}
