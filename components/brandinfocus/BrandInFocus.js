        ...
        <div className=''>
            ...
            <div className=' w-full mt-32 px-3 md:px-10'>
                ...
                <div className='flex md:flex-row gap-6 md:gap-0 flex-col w-full justify-between h-[100vh] mt-10'>
                    <div className='w-screen md:w-[30%] h-full flex justify-center items-center border '>ADVERTISMENT</div>
                    <div className='w-screen md:w-[68%] h-full flex flex-col  justify-between items-center'>
