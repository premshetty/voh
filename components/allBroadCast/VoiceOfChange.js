...
const AllCard = () => {
  const ConstantData = [{}];
  return (
    <div className="h-[400px] min-w-[300px] border-[#F7F7F7] border-[5px] p-5 relative">
      <div className="h-full w-full border-[#AD565B] border-[5px] rounded-[30px] p-5">
        <img src="/allbroadcast/pic1st.png" className="absolute  w-full object-cover -z-30 top-16 left-0" alt="" />
