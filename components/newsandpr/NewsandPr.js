...
export const Card1 = () => {
    return (
        <div className={`${classes.IdeaLeaderCard2} flex gap-5 relative h-[330px] mt-10 w-full pr-10 p-5`}>
            <img className='h-full w-[40%] object-cover' src="/persons/news.png" alt="" />
            <div className=' flex flex-col gap-4 '>
                <h2 className='font-bold text-[32px]'>No dearth of platelets, beds for dengue patients in UP: Dy CM Pathak ..</h2>
                <p className='text-lg'>Uttar Pradesh Deputy Chief Minister Brajesh Pathak on Thursday claimed there is no dearth of platelets and beds for the Uttar Pradesh Deputy Chief Minister Brajesh Pathak on Thursday claimed there is no dearth of platelets and beds for the Uttar Pradesh Deputy Chief Minister Brajesh Pathak on Thursday claimed there is no dearth of platelets and beds for the ….. </p>
...
export const Card2 = () => {
    return (
        <div className={`${classes.IdeaLeaderCard2} flex gap-5 relative h-[330px] w-[700px] pr-10 p-5`}>
            <div className=' flex flex-col gap-4 '>
                <h2 className='font-bold text-[28px]'>No dearth of platelets, beds for dengue patients in UP: Dy CM Pathak ..</h2>
            ...
            <img className='h-full w-[250px] rounded-2xl object-cover' src="/persons/news.png" alt="" />
        ...
        <>
            ...
            <div className='px-10 w-full mt-32'>
                ...
                <div className='mt-10'>
                    ...
                    <div className='grid grid-cols-2 gap-y-8 justify-items-stretch mt-10'>
                        <Card2 />
                        <Card2 />
                        <Card2 />
                        <Card2 />
