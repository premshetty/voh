    ...
    return (
        <div className={`${classes.IdeaLeaderCard2} h-[320px] min-w-[620px] p-5 flex`}>
            <div className='px-5 flex flex-col gap-4 mt-3'>
                ...
                <p className='text-sm text-[#2C2A2A] opacity-70'>The self -hygiene is one of the important of healthy habits which is very less thought. Of course, the doctors are constantly making points to the patients about self-hygiene as many of infectious conditions can be easily avoided if they follow the regular guidance of self-cleanliness.</p>
